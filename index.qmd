...
::: {.callout-tip appearance="minimal" title="<i class=\"bi bi-rss\"></i> RSS feeds to follow changes and news"}

- [additions to or substantial revisions of the web site](https://neelsmith.quarto.pub/posts.xml) 
- [new releases of Julia packages or updates to package documentation](https://neelsmith.quarto.pub/updates.xml)
:::