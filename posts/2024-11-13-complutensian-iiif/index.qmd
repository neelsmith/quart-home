...
There are [numerous freely available viewer applications](https://iiif.io/get-started/iiif-viewers/) for browsing images from a IIIF manifest. At this point, to browse the images for a volume of the Complutensian, you can copy any one fo these URLs, and paste them in to the IIIF viewer of your choice.
